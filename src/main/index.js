...
huoyun.controller("appController", ["$scope", "Dialog", "HttpErrorHandler", "InitService", "BoState", "Session",
  "HuoYunWidgets", "NewSession",
  function($scope, Dialog, HttpErrorHandlerProvider, InitService, BoStateProvider, SessionProvider, HuoYunWidgets,
    NewSessionProvider) {
    ...
    InitService.getInitData()
      .then(function(initData) {
        ...
        NewSessionProvider.setUser(initData.employee);
        NewSessionProvider.setCompany(initData.company);
